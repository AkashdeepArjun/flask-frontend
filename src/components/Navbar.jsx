        ...
        <div className=" relative max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-xs font-medium text-emerald-400">
                ...
                <span> Flask Api conntected  </span>
                    ...
                    <div className="absolute top-3 right-4 w-24 h-24  rounded-full border-2 border-dashed bg-slate-950 border-slate-700 flex items-center justify-center overflow-hidden">
